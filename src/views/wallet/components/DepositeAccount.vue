  ...
  >
    <div class="card-header">
      <div class="card-title">
        <h2 class="fw-bolder">{{ $t("depositAccount") }}</h2>
      </div>
    ...
    <div class="card-body pt-0" v-for="account in AccountsInDepositeToWallet">
                ...
                <table class="table table-flush fw-bold gy-1">
                  <tbody>
                    ...
                    <tr v-if="account.bankCardNumber">
                      ...
                      <td class="text-gray-800">
                        {{ "********" + getLastNums(account.bankCardNumber) }}
                      </td>
                    </tr>
                    ...
                    <tr v-if="account.bankCardSecurityNumber">
                      ...
                      <td class="text-gray-800">
                        {{ account.bankCardSecurityNumber }}
                      </td>
                    </tr>
...
import AddAccountModal from "@/views/Account/components/AddAccountModal.vue";

const store = useStore();
const AccountsInDepositeToWallet = computed(
...
const SetAsDefaultDeposite = (accountId) => {
  ...
  store.dispatch(Actions.SET_DEFAULT_ACCOUNT_DEPOSITE, payload);
};
</script>
