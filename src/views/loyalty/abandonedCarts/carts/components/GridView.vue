<template>
  <div class="row g-4">
    <div v-for="(item, i) in items" :key="i" class="col-12 col-md-6 col-xl-4">
      <div class="card shadow-sm">
        <div class="card-toolbar mx-4 my-2 d-flex justify-content-end align-items-center">
          <div class="dropdown">
            ...
            >
              ...
              <div class="menu-item px-3">
                <a
                  @click="emit('delete-abandonedCart')"
        ...
        >
          <h2>
            <button
              class="bg-transparent border-0 text-primary bold"
              style="font-weight: bold"
            >
              {{ item.clientFirstName + " " + item.clientLastName }}
            </button>
          </h2>
          <small class="text-gray-400">{{ item.clientEmail }}</small>
          <small class="text-gray-400">{{ item.clientPhoneNumber }}</small>
          ...
          <div class="d-flex mt-5">
            ...
            >
              ...
              <div class="fw-bold text-gray-400">{{ $t("createdAt") }}</div>
            </div>
            ...
            >
              ...
              <div class="fw-bold text-gray-400">{{ $t("totalCartAmmount") }}</div>
            </div>
          </div>
        </div>
      </div>
...
let emit = defineEmits(["delete-abandonedCart", "update-pagination"]);
